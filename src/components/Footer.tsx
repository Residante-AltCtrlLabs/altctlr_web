      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Alternative Control</a></li>
              <li>
                <a href="#" className="text-white/80 hover:text-white transition-colors">Résidanté</a>
                <span className="text-white/50 text-sm ml-2">Coming soon</span>
              </li>
              <li>
                <a href="#" className="text-white/80 hover:text-white transition-colors">Melkeyat</a>
                <span className="text-white/50 text-sm ml-2">Coming soon</span>
              </li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Trust & Security</a></li>
            </ul>
          </div>
        </div>
